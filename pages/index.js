  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded-lg shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {status === 'success' && (<p className="text-green-600 mt-2">Details submitted successfully!</p>)}
        {status === 'error' && (<p className="text-red-600 mt-2">Submission failed. Please try again.</p>)}
      </form>
    </div>
  );
}
